		...
		<form action="auth?action=updateProfile" method="post"
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					...
					<div
						class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 capitalize">
						${user.role}</div>
				</div>
			...
			<!-- Action Buttons -->
			<div
				class="flex items-center justify-center gap-4 mt-8 pt-6 border-t border-gray-200">
				<button type="submit"
