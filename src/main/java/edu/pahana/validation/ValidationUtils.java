...
public class ValidationUtils {
     ...
     */
    public static Map<String, String> validateCustomer(String accountNumber, String name, String address, String telephone) {
        ...
        if (!isNotEmpty(accountNumber)) {
            ...
            errors.put("accountNumber", "Account number must be 3-20 characters long and contain only letters and numbers");
        }
     ...
     */
    public static Map<String, String> validateProduct(String name, String description, String price, String isbn, String author, String publisher) {
        Map<String, String> errors = new HashMap<>();
     ...
     */
    public static Map<String, String> validateRegistration(String firstName, String lastName, String username, String email, String password, String confirmPassword) {
        Map<String, String> errors = new HashMap<>();
